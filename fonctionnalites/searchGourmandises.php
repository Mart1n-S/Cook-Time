...
if (isset($search) && $search !== '%%') {
    ...
    if ($resultatRequeteSQLRecettesPublic == '' || $resultatRequeteSQLRecettesPublic == NULL) {
        ...
        foreach ($resultatRequeteSQLRecettesPublic as $row) {
            ...
            echo '<li class="resultatRecherche" onclick="goRecette.call(this)"><a href="index.php?action=recettes-gourmandises&recette=' . $row['RECETTE_TITRE'] . '">' . $row['RECETTE_TITRE'] . '</a></li>';
        }
        echo '</ol>';
    }
}
