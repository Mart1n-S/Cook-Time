...
$navigationEnCoursRecette = "desserts";
?>
    ...
    <?php if (utilisateurConnecte()) { ?>
        ...
        if (isset($search) && $search !== '' || isset($page) && isset($search) && $search !== '') {
            ...
            if (!filter_var($pageParDefaut, FILTER_VALIDATE_INT) || $pageParDefaut <= 0) {
                header("Location: index.php?action=recettes-desserts&page=1");
            }
            ...
            $resultatRecettesPublic = recettesDessertsPublic2($debut, $recetteParPage, $search);
            ...
            if ($resultatRecettesPublic == '' || $resultatRecettesPublic == NULL) {
                ...
                foreach ($resultatRecettesPublic as $recette) {
                    ...
                    if ($typeRecettePublic === 'Dessert' && $visibiliteRecettePublic === 1) { ?>
                ...
                <div class="pagination">
                    <?php
                    if ($page > 1) {
                        echo '<a href="index.php?action=recettes-desserts&page=' . ($page - 1) . '&recette=' . $search . '" ><<</a>';
                    }
                    if ($nombrePage > 1) {
            ...
            $resultatRecettesPublic = recettesDessertsPublic($debut, $recetteParPage);
            ...
            <div class="pagination">
                <?php
                if ($page > 1) {
                    echo '<a href="index.php?action=recettes-desserts&page=' . ($page - 1) . '" ><<</a>';
                }
                echo '<div class="checkPage"><form method="get">
                <input type="hidden" name="action" value="recettes-desserts">
