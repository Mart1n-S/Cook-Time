...
const input1 = document.getElementById("PhotoProfilInscription1");
...
var email = document.getElementById("emailInscription1");
var confirmEmail = document.getElementById("emailInscriptionConfirmation1");
...
//Empeche dans tous les cas la validation du formulaire si les 2 champs mdp ne sont pas identiques mais vérifier tout de même avec php s'il n'y a pas d'erreur.
var password = document.getElementById("motDePasseInscription1");
var confirmPassword = document.getElementById("motDePasseInscriptionConfirmation1");
...
function showPassword() {
  ...
  var passwordInput1 = document.getElementById("motDePasseInscription1");
  var confirmPasswordInput = document.getElementById("motDePasseInscriptionConfirmation1");
...
function setAgeRange() {
    ...
    document.getElementById("ageInscription1").min = minAge.toISOString().substr(0, 10);
    document.getElementById("ageInscription1").max = maxAge.toISOString().substr(0, 10);
}